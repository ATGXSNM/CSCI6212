...
#configures Google auth
config :elixir_auth_google,
  client_id: "650890407853-rs4oal138hvjuv5782b42303r5oq353h.apps.googleusercontent.com",
  client_secret: "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"
